# Usage: docker build --build-arg NODE_VERSION=18.19.0 --build-arg WAZUH_DASHBOARDS_BRANCH=4.10.1 --build-arg WAZUH_DASHBOARDS_PLUGINS=4.10.1 --build-arg WAZUH_SECURITY_DASHBOARDS_PLUGIN_BRANCH=4.10.1 --build-arg OPENSEARCH_DASHBOARDS_VERSION=2.16.0 -t wzd:4.10.1 -f wazuh-dashboard.Dockerfile .
